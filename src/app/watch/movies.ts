// Shared movie data + lookup helpers for the watch catalog and detail pages.
...
// Ultra High Resolution 4K Hero Slides
...
export const PEEKING_CARDS = [
  { id: "peek-1", title: "Spider-Man 2D", image: "https://images.unsplash.com/photo-1635805737707-575885ab0820?q=90&w=800&auto=format&fit=crop" },
  { id: "peek-2", title: "Toy Story 5", image: "https://images.unsplash.com/photo-1593085512500-5d55148d6f0d?q=90&w=800&auto=format&fit=crop" },
  { id: "peek-3", title: "Wall-E Art", image: "https://images.unsplash.com/photo-1531346878377-a5be20888e57?q=90&w=800&auto=format&fit=crop" },
  { id: "peek-4", title: "Kung Fu Panda", image: "https://images.unsplash.com/photo-1508739773434-c26b3d09e071?q=90&w=800&auto=format&fit=crop" },
  { id: "peek-5", title: "Anime City", image: "https://images.unsplash.com/photo-1518709268805-4e9042af9f23?q=90&w=800&auto=format&fit=crop" },
  { id: "peek-6", title: "Vector Star", image: "https://images.unsplash.com/photo-1500485035595-cbe6f645feb1?q=90&w=800&auto=format&fit=crop" },
];
...
// Per-title synopsis used by the hover popover and the detail page.
const MOVIE_DESCRIPTIONS: Record<string, string> = {
...
export function getMovieDesc(title: string): string {
  return (
    MOVIE_DESCRIPTIONS[title] ||
    "An exciting cinematic story filled with unforgettable characters, gorgeous hand-drawn animation, and thrilling adventure."
  );
}

// Flat lookup across hero + all catalog sections.
const ALL_MOVIES: Movie[] = [
  ...HERO_SLIDES,
  ...MOVIE_SECTIONS.flatMap((section) => section.movies),
];
...
// Related titles for the "You may also like" grid (excludes the current one).
export function getRelated(id: string, count = 12): Movie[] {
  const seen = new Set<string>([id]);
  const related: Movie[] = [];
  for (const movie of MOVIE_SECTIONS.flatMap((s) => s.movies)) {
